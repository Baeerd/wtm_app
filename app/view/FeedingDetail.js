/*
 * File: app/view/FeedingDetail.js
 *
...
Ext.define('SYSM.view.FeedingDetail', {
    extend: 'Ext.Container',
    alias: 'widget.feedingDetail',
    ...
    onMybutton8Tap11: function(button, e, eOpts) {
        var view = button.up('#putawayView');
