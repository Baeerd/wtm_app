/*
 * File: app/view/EXWarehouseProduct.js
 *
...
Ext.define('SYSM.view.EXWarehouseProduct', {
    extend: 'Ext.Container',
    alias: 'widget.exWarehouseProduct',
    ...
    config: {
        ...
        listeners: [
            ...
            {
                fn: 'onProductWasteOutMatTap',
                event: 'tap',
                delegate: '#productWasteOutMat'
            },
            {
                fn: 'onProductReRollTap',
                event: 'tap',
                delegate: '#productReRoll'
            },
            {
                fn: 'onProductOffLineTap',
                event: 'tap',
                delegate: '#productOffLine'
            }
        ]
    },
    ...
    onMytextfield1Blur: function(textfield, e, eOpts) {
        console.log('失去焦点');
        var currentView = textfield.up('#exWarehouseProduct');
    ...
    onProductWasteOutMatTap: function(button, e, eOpts) {
        var me = button;//1410358722010
        var view = me.up('#exWarehouseProduct');
    ...
    onProductReRollTap: function(button, e, eOpts) {
        var me = button;//1410358722010
        var view = me.up('#exWarehouseProduct');
        var data = view.getData();
        var target = view.down('#target');//.getValue();
        ...
        // }
            ...
            Ext.Ajax.request({
                //     url: 'system/login!login.action',
                //     url:'http://192.168.0.112/mes-wtm-app/wtm/inventory-check!saveRecords.action',
                url:rootUrl+'/wtm/wtm-waste!reRoll.action',
                method:'POST',
                params: {
                    'matList':str
                },
    ...
    onProductOffLineTap: function(button, e, eOpts) {
        var me = button;//1410358722010
        var view = me.up('#exWarehouseProduct');
        var data = view.getData();
        var target = view.down('#target');//.getValue();
        ...
        // }
            ...
            Ext.Ajax.request({
                //     url: 'system/login!login.action',
                //     url:'http://192.168.0.112/mes-wtm-app/wtm/inventory-check!saveRecords.action',
                url:rootUrl+'/wtm/wtm-waste!offLine.action',
                method:'POST',
                params: {
                    'matList':str
                },
