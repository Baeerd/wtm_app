...
Ext.define('SYSM.view.MenuDataItem', {
    ...
    updateRecord: function(record) {
        ...
        //     console.log(record);
            ...
            // //     console.log(this);
            //     Ext.Msg.alert('消息', record.get('label'), Ext.emptyFn);
            // });

            // me.element.on('touchstart',function(){
            //     //     console.log('touchstart');
            //     me.down('#menuDataItemBG').setCls('menu_item_passdown');
            // });
            // me.element.on('touchend',function(){
            //     //     console.log('touchend');
            //     me.down('#menuDataItemBG').setCls('menu_item_bg');
            // });
        }
